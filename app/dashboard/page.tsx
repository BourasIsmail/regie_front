                        ...
                        {loadingPlafonds ? (
                            ...
                            <div className="max-h-[500px] overflow-auto">
                              ...
                              <span className="font-medium text-foreground">
                                ...
                                <span className="inline-flex items-center rounded bg-[#059669]/10 px-2 py-0.5 text-[#059669]">
                                  Plafond Annuel: {formatCurrency(p.budgetAnnuelInitial || 0)}
                                </span>
                                                            <span className="inline-flex items-center rounded bg-[#1A3A8A]/10 px-2 py-0.5 text-[#1A3A8A]">
                                  Disponible Rubrique: {formatCurrency(p.plafondAnnuel)}
                                </span>
